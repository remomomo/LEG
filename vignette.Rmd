...
Out of 34 submitted regions, 3 overlap newly predicted limb-enhancers (**Figure 4**), with one of them even ranking in the top 1,000 highest scoring elements. Notably, none of these were identified by our simple approach above, as they're lying further away from the target gene (we limited the analysis to 500kb window around Sox9).
...
Performing these steps resulted in a set of 15,586 regions available <a href="http://portal.nersc.gov/dna/RD/ChIP-Seq/LEG_trackhub/GSE42413_human_H2K27ac_intersections.bed" target="_blank">here</a>. **Figure 6** shows the distribution of element widths submitted in this analysis.
...
<center><img src="www/great_results.png" alt="" style="width:80%;max-width:1000px;padding:5px"></center>
